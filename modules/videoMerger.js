    ...
    try {
      ...
      const command = ffmpeg()
        ...
        .inputOptions([
          "-f concat", 
          "-safe 0",
          "-probesize 200M",                 // Probe size lớn
          "-analyzeduration 200M"            // Analyze duration lớn
        ])
        .outputOptions([
          "-c:v libx264",                    // H.264 codec
          "-c:a aac",                        // AAC codec
          "-crf 18",                         // Chất lượng cao hơn
          "-preset slow",                    // Chất lượng tốt nhất
          "-r 30",                           // 30fps cố định
          ...
          "-max_muxing_queue_size 8192",     // Large buffer
    ...
    try {
      ...
      const command = ffmpeg()
        ...
        .outputOptions([
          ...
          "-max_muxing_queue_size 4096",     // Tăng buffer queue
          "-probesize 100M",                 // Tăng probe size
          "-analyzeduration 100M",           // Tăng analyze duration
